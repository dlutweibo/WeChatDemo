...
- (void)viewDidLoad {
    ...
    if (self.navigationController.tabBarItem.badgeValue.length != 0) {
        self.navigationItem.title = [NSString stringWithFormat:@"微信(%@)", self.navigationController.tabBarItem.badgeValue];
    }
